...
#[no_mangle]
pub unsafe extern "C" fn light_file_is_writable(mut filename: *const libc::c_char) -> bool {
    let mut fp: *mut FILE = 0 as *mut FILE;
    fp = fopen(filename, b"r+\0" as *const u8 as *const libc::c_char);
    if fp.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn light_mkpath(mut dir: *mut libc::c_char, mut mode: mode_t) -> libc::c_int {
